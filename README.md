...
| **[JobN8N](https://github.com/oft24/JobN8N)** | Importable n8n workflow that aggregates job listings, routes OCC through a dedicated proxy path to avoid Cloudflare blocks, scores matches with local rules and optional Gemini refinement, deduplicates results and sends a Gmail digest. | n8n · JavaScript · Gemini · Gmail | — |
